...
namespace PPTVideo
{
    class FlaskConnect
    {
        ...
        //发送教师视频
        public bool SendTeacherVideo(string jsonData, string videoFile)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, videoFile, m_ipPort + "/Send_Teacher_Video");
            if (response != null)
            {
                bool result = FlaskResponse(response);
                return result;
        ...
        //配置wav2lip参数
        public bool SendWav2LipConfig(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Send_Wav2Lip_Config");
            if (response != null)
            {
                bool result = FlaskResponse(response);
                return result;
        ...
        //推理VITS跟Sadtalker
        public bool GetInferenceVitsSadtalker(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Get_Inference_VITS_Sadtalker");
            if (response != null)
            {
        ...
        //推理用户音频跟Sadtalker
        public bool GetInferenceUserSadtalker(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Get_Inference_User_Audio_Sadtalker");
            if (response != null)
            {
                bool result = FlaskResponseState(response, 60000, jsonData);
                return result;
        ...
        //推理VITS跟Wav2Lip
        public bool GetInferenceVitsWav2Lip(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Get_Inference_VITS_Wav2Lip");
            if (response != null)
            {
                bool result = FlaskResponseState(response, 60000, jsonData);
                return result;
        ...
        //推理用户音频跟Wav2Lip
        public bool GetInferenceUserWav2Lip(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Get_Inference_User_Audio_Wav2Lip");
            if (response != null)
            {
                bool result = FlaskResponseState(response, 60000, jsonData);
                return result;
        ...
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Get_Inference_VITS_Multiple");
            if (response != null)
            {
                bool result = FlaskResponseState(response, 60000, jsonData);
                return result;
        ...
        //获取用户音频长度
        public bool ReciveUserWavTime(string jsonData, string savePath)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Recive_User_Wav_Time");
            if (response != null)
            {
                bool result = FlaskResponseJsonSave(response, savePath);
                return result;
        ...
        //推理融合的视频(可选择插入)
        public bool PptVideoMergeSelectInto(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/PPT_Video_Merge_Select_Into");
            if (response != null)
            {
                bool result = FlaskResponseState(response, 60000, jsonData);
                return result;
        ...
        //推理融合的视频(全没有插入)
        public bool PptVideoMergeNoInto(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/PPT_Video_Merge_No_Into");
            if (response != null)
            {
                bool result = FlaskResponse(response);
                return result;
        ...
        //发送插入PPT的音频
        public bool SendInsertWav(string jsonData, string wavPath)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, wavPath, m_ipPort + "/Send_PPT_Audio");
            if (response != null)
            {
                bool result = FlaskResponse(response);
                return result;
        ...
        //获取训练的VITS模型的名字
        public bool GetTrainVitsName(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Get_Train_VITS_Model_Name");
            if (response != null)
            {
        ...
        //发送数字人插入的页数
        public bool SendPeopleLocation(string jsonData)
        {
            HttpResponseMessage response = ConnectFlask(jsonData, m_ipPort + "/Send_People_Location");
            if (response != null)
            {
                bool result = FlaskResponse(response);
                return result;
